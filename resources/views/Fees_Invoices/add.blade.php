                                        ...
                                        {{-- <div data-repeater-list="List_Fees"> --}}
                                            {{-- <div data-repeater-item> --}}
                                                <div class="row">
                                                    <div class="col">
                                                        <label for="Name" class="mr-sm-2">اسم الطالب</label>
                                                        <input type="text" class="form-control" value="{{ $student->name }} {{ $student->myparent->Name_Father }} "  readonly>
                                                        {{-- <select class="fancyselect" name="student_id" required>
                                                                <option value="{{ $student->id }}">{{ $student->name }}</option>
                                                        </select> --}}
                                                    </div>
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="box">
                                                            ...
                                                            <select  class="form-control" name="Amount" style="padding: 10px;">
                                                                {{-- <option value="">-- اختار من القائمة --</option>
                                                                @foreach($fees as $fee)
                                                                    <option value="{{ $fee->amount }}">{{ $fee->amount }}</option>
                                                                @endforeach --}}
                                                    ...
                                                    <input type="hidden" name="Classroom_id" value="{{$student->Classroom_id}}">
                                                    <div class="col">
                                                        <label for="Name_en" class="mr-sm-2">{{ trans('حفظ') }}:</label>
                                                        <button type="submit" class="btn btn-primary">تاكيد البيانات</button>
                                                    </div>
                                                    <div class="col">
                                                        <label for="Name_en" class="mr-sm-2">{{ trans('رجوع لقائمه الطلاب') }}:</label>
